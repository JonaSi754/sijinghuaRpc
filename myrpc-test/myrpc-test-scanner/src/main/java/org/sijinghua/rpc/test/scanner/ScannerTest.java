...
public class ScannerTest {
    /**
     * 扫描org.sijinghua.rpc.test.scanner包下所有的类
     */
    @Test
    public void testScannerClassNameList() throws Exception {
        List<String> classNameList = ClassScanner.getClassNameList("org.sijinghua.rpc.test.scanner");
        classNameList.forEach(System.out::println);
    }

    /**
     * 扫描org.sijinghua.rpc.test.scanner包下所有标注了@RpcService的类
     */
    @Test
    public void testScannerClassNameListByRpcService() throws Exception {
        RpcServiceScanner.doScannerWithRpcServiceAnnotationAndRegistryService("org.sijinghua.rpc.test.scanner");
    }
